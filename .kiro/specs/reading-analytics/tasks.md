...
- [ ] 1. Add read_progress table and API routes to server.js
  ...
  - [-] 1.2 Add POST `/api/reading-progress` route to `ebook/api/server.js`
  ...
  - [-] 1.3 Add GET `/api/admin/reading` route to `ebook/api/server.js`
